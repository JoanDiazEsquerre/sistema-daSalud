...
public class SucursalServiceImpl implements SucursalService {
	...
	@Override
	public Page<Sucursal> findByEstadoAndNombreLike(boolean estado, String nombre, Pageable pageable) {
		// TODO Auto-generated method stub
		return sucursalRepository.findByEstadoAndNombreLike(estado, nombre, pageable);
	} 
