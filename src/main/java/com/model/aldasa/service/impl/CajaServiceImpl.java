...
public class CajaServiceImpl implements CajaService {
	...
	@Override
	public List<Caja> findBySucursalAndEstadoAndUsuario(Sucursal sucursal, String estado, Usuario usuario) {
		// TODO Auto-generated method stub
		return cajaRepository.findBySucursalAndEstadoAndUsuario(sucursal, estado, usuario);
	}
