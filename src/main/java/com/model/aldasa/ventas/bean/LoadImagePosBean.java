...
public class LoadImagePosBean {
	...
	public StreamedContent graphicImage;
	 ...
	 public byte[] getImage() throws IOException {
		 String ruta = navegacionBean.getSucursalLogin().getEmpresa().getRutaImagenPost()+"0.png";
//		 String ruta = "/home/imagen/voucher_separaciones/0.png"; 
		 if(!nombreArchivo.equals("")) {
			 ruta = navegacionBean.getSucursalLogin().getEmpresa().getRutaImagenPost()+nombreArchivo;
